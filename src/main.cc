...
void print_roi_stats(uint32_t cpu, CACHE *cache)
{
	...
	<< endl;
	//cout << "Pure^2_miss " << cache->pure2_miss << endl;
	cout << "Pure^3_miss " << cache->pure3_miss << endl;
...
void reset_cache_stats(uint32_t cpu, CACHE *cache)
{
    ...
    //cache->L1D_active_hit_cycles_per_core.clear();
    //cache->L2C_active_hit_cycles_per_core.clear();
